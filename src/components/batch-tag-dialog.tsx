...
export default function BatchTagDialog({
  ...
  const handleApply = () => {
    ...
    toast({
      title: "Tags Applied",
      description: `Successfully added ${tags.length} tag(s) to ${fileCount} file(s).`,
    })
    reset()
  }
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Add Tags to {fileCount} {fileCount === 1 ? 'File' : 'Files'}
          </DialogTitle>
          <DialogDescription>
            Select existing tags or create new ones to apply to all selected files.
          </DialogDescription>
        </DialogHeader>
